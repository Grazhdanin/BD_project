...
CREATE TABLE `channel_points` (
  ...
  PRIMARY KEY (`id`),
  KEY `channel_points_midia_channel_fk` (`midia_channel`),
  KEY `channel_points_user_id_fk` (`user_id`),
  CONSTRAINT `channel_points_midia_channel_fk` FOREIGN KEY (`midia_channel`) REFERENCES `streamer_channel` (`id`),
  CONSTRAINT `channel_points_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `profile` (`id`)
...
CREATE TABLE `friendship` (
  ...
  CONSTRAINT `friendship_friend_id_fk` FOREIGN KEY (`friend_id`) REFERENCES `profile` (`id`) ON DELETE CASCADE,
  CONSTRAINT `friendship_status_id_fk` FOREIGN KEY (`status_id`) REFERENCES `friendship_statuses` (`id`),
  CONSTRAINT `friendship_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `profile` (`id`) ON DELETE CASCADE
...
CREATE TABLE `media` (
  ...
  KEY `media_midia_channel_fk` (`midia_channel`),
  ...
  CONSTRAINT `media_midia_channel_fk` FOREIGN KEY (`midia_channel`) REFERENCES `streamer_channel` (`id`),
  CONSTRAINT `media_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `profile` (`id`)
...
CREATE TABLE `messages` (
  ...
  CONSTRAINT `messages_from_user_id_fk` FOREIGN KEY (`from_user_id`) REFERENCES `profile` (`id`),
  CONSTRAINT `messages_to_user_id_fk` FOREIGN KEY (`to_user_id`) REFERENCES `profile` (`id`)
...
CREATE TABLE `profile` (
  ...
  `updated_at` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Время обновления строки',
  PRIMARY KEY (`id`),
  KEY `profile_display_name_idx` (`display_name`)
...
--
-- Table structure for table `streamer_channel`
--

DROP TABLE IF EXISTS `streamer_channel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `streamer_channel` (
  ...
  CONSTRAINT `streamer_channel_id_fk` FOREIGN KEY (`id`) REFERENCES `streamer_channel_users` (`community_id`),
...
--
-- Dumping data for table `type_subscriptions`
--

LOCK TABLES `type_subscriptions` WRITE;
/*!40000 ALTER TABLE `type_subscriptions` DISABLE KEYS */;
INSERT INTO `type_subscriptions` VALUES (1,'Followers','2020-09-20 20:40:05','2020-09-20 20:40:05'),(2,'subscription_1_lv','2020-09-20 20:40:05','2020-09-20 20:40:05'),(3,'subscription_2_lv','2020-09-20 20:40:05','2020-09-20 20:40:05'),(4,'subscription_3_lv','2020-09-20 20:40:05','2020-09-20 20:40:05');
/*!40000 ALTER TABLE `type_subscriptions` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50001 VIEW `category_number_viewers` (`category`,`total_users`) AS select `sections`.`name` AS `name`,count(`streamer_channel_users`.`user_id`) AS `COUNT(streamer_channel_users.user_id)` from ((`sections` left join `streamer_channel` on((`streamer_channel`.`sections_id` = `sections`.`id`))) left join `streamer_channel_users` on((`streamer_channel_users`.`community_id` = `streamer_channel`.`id`))) group by `sections`.`name` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `points_channel` (`streamer`,`viewer`,`points`) AS select `streamer_channel_users`.`community_id` AS `community_id`,`streamer_channel_users`.`user_id` AS `user_id`,`channel_points`.`points` AS `points` from (`streamer_channel_users` left join `channel_points` on(((`streamer_channel_users`.`user_id` = `channel_points`.`user_id`) and (`streamer_channel_users`.`community_id` = `channel_points`.`midia_channel`)))) where (`channel_points`.`points` <> 0) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2020-09-29  1:12:12
